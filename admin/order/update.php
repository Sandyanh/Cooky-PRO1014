...
if (is_array($order)) {
    extract($order);
    $bill_pay_method_text = ($ngaydathang == 1) ? "Thanh toán khi nhận hàng" : "Thanh toán online";
}
?>
<div class="p-4">
    ...
    <form action="index.php?act=order-update" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="form-group col">
                ...
                <input type="text" name="order_date" id="order_date" class="form-control form-control-sm" value="<?= $ngaydathang ?>" readonly>
            </div>
            <div class="form-group col">
