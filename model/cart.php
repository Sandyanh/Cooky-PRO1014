...
function bill_insert($id_user, $username, $address, $phone, $email, $pay_method, $order_date, $total_order)
{
    $sql = "INSERT INTO bill(iduser, bill_name, bill_address, bill_tel, bill_email, bill_pttt, ngaydathang,total) VALUES ('$id_user','$username', '$address', '$phone',  '$email', '$pay_method','$order_date', '$total_order')";
    return pdo_execute_return_lastInsertId($sql);
}
function cart_insert($id_user, $id_product, $image, $name, $price, $quantity, $into_money, $id_bill)
{
    $sql = "INSERT INTO cart(iduser, idpro, img, name, price,soluong,thanhtien, idbill) VALUES ('$id_user', '$id_product', '$image', '$name', '$price', '$quantity', '$into_money', '$id_bill')";
    pdo_execute($sql);
}
